...
def generate_launch_description():
    ...
    pkg_kogrob_etoe_nn_driving = get_package_share_directory('KogRob-EtoE-NN-Driving')

    os.environ["GZ_SIM_RESOURCE_PATH"] += os.pathsep + pkg_kogrob_etoe_nn_driving + "/gazebo_models"
    ...
    rviz_node = Node(
        package='rviz2',
        executable='rviz2',
        arguments=['-d', PathJoinSubstitution([pkg_kogrob_etoe_nn_driving, 'rviz', LaunchConfiguration('rviz_config')])],
